...
Version  : 1.1.5
Release  : 35
URL      : https://cran.r-project.org/src/contrib/brio_1.1.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/brio_1.1.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714064224
...
/usr/lib64/R/library/brio/tests/testthat/test-brio-package.R
/usr/lib64/R/library/brio/tests/testthat/test-file_line_endings.R
/usr/lib64/R/library/brio/tests/testthat/test-package.R
...
/usr/lib64/R/library/brio/tests/testthat/test-write_file_raw.R
/usr/lib64/R/library/brio/tests/testthat/test-write_lines.R

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/brio/libs/brio.so
/V4/usr/lib64/R/library/brio/libs/brio.so
